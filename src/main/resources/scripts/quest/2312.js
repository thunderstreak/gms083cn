...
function start(mode, type, selection) {
	...
	if (mode != 1) {
	    if(type == 1 && mode == 0)
			...
			qm.sendOk("嗯。。。你一定对战斗的技巧还不熟悉。我们会在这里等你，等你准备好了再来找我们。");
		    qm.dispose();
			return;
		}
	}
	if (status == 0)
		qm.sendAcceptDecline("我们需要你的帮助，英明神武的探险家。我们的王国现在面临着巨大的威胁，我们迫切需要一个勇敢的冒险家愿意为我们而战，不过我们必须先测试你的能力，然后才能坚定地支持你。你能帮我们吗？");
	else if (status == 1){
		qm.forceStartQuest();
