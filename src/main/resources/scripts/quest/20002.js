...
function start(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode > 0)
            ...
            status--;
        if (status == 0)
            qm.sendNext("什么？南哈特派你来的？啊，你一定是个新手。欢迎，欢迎。我叫基库，我的工作是训练和塑造像你这样的孩子成为真正的骑士. 额... 你为什么那样看着我。。。啊，你以前一定没见过皮尤.");
        else if (status == 1)
            ...
            qm.sendOk("哈，我喜欢你的热情，但在我们开始之前，你必须先为训练做好准备。确保你装备了武器，并且你的技能已经准备好使用。我也给了你一些药水，所以准备好以防万一。准备好了就告诉我.");
        } else if (status == 4) {
            qm.dispose();
        }
    }
