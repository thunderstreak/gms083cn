...
function start(mode, type, selection) {
	...
	if (status == 0) {
		qm.sendNext("最近农场里的 #o1210100#s 变得很奇怪.它们变得易怒和无缘无故地发脾气.所以今天我一大早就到农场里检查,果不其然我发现有一些 #o1210100#s 翻越围栏，逃到外面去了.");
	} else if (status == 1) {
		...
		if (mode == 0) {//decline
			...
			qm.forceStartQuest();
			qm.sendNext("哦，真是谢谢你。#b#t4032498##k可以从周围的#r#o0130100##k身上搜集到。它们虽然不是很强，但也不要大意轻敌.");
		}
	} else if (status == 3) {
