...
function start(mode, type, selection) {
	...
	if (status == 0) {
		...
		qm.sendNextPrev("我记得…我在去彩虹岛的路上，本来想去探险的。。。然后怎么了？发生什么事？", 2);
	} else if (status == 2) {
		qm.sendNextPrev("哦！哦！哦！哦哦！");
	} else if (status == 3) {
		qm.sendNextPrev("当时我在和船长谈话，欣赏风景，然后。。。蝙蝠魔！蝙蝠魔袭击了那艘船！所以。。。我落水了吗？但是，但为什么我还活着？我知道#b我会游泳#k,但我能在失去知觉的时候游泳吗？也许我可以。难道我真的是天才！", 2);
	} else if (status == 4) {
