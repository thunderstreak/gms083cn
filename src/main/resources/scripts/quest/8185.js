...
/* 	Author: 		Blue
	Name:	 		Garnox 加诺克斯
	Map(s): 		New Leaf City : Town Center 新叶城：市中心
	Description: 	Quest - Pet Evolution2 探索-宠物进化2
*/
...
function end(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
			...
			qm.sendNext("#e#b嘿，是你干的!#n#k \r\n#r哇噢!#k 我现在可以完成对你宠物的研究了!");
		} else if (status == 1) {
			if (mode == 0) {
				qm.sendOk("我知道了。。。你想做的时候就回来。我真的很兴奋.");
				qm.dispose();
			} else {
				qm.sendNextPrev("就是说，你的龙的新颜色可能是#e#r随机的#k#n！可能是#r绿色，可能是#b蓝色，可能是#r红色, #d或者是稀有的#k,黑色. \r\n\r\n#fUI/UIWindow.img/QuestIcon/5/0# \r\n\r\n如果你不喜欢你宠物的新颜色, 或者如果你想再次改变你的宠物的颜色, 你可以#b再买一块进化之石,需要花费10,000金币#k。请准备好你的#b宠物#k然后与我对话。");
			}
		} else if (status == 2) {
			qm.sendYesNo("现在让我试着让你的宠物进化.准备好了吗？想看看你可爱的小龙变成成熟的深黑色，蓝色，平静的绿色，或火红的颜色吗？不用担心，不会影响颜色以外的任何东西. \r\n\r\n#b#e你想继续还是想再考虑考虑?#k#n");
                } else if (status == 3) {
