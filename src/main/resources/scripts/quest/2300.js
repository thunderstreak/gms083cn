        ...
        if(mode == 0 && type > 0) {
            if (status != 3) {
                ...
                if (qm.canHold(4032375, 1)) {
                    qm.sendNext("可以。那样的话，我就告诉去蘑菇城堡的路线。#b在射手村西边的出租车附近，#k你会发现#b有一颗大树#k.跳到顶端进入这颗大树, 然后从左下角的入口进入#b<主题地图:蘑菇城堡>#k.那是蘑菇城堡的入口。时间不多了！");
                } else {
            ...
            if (status == 0) {
                qm.sendAcceptDecline("既然你已经取得了工作进展，而且看起来也已经准备好了。我有件事想请你帮忙。你愿意听吗?");
            } else if (status == 1) {
