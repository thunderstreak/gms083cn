...
function action(mode, type, selection) {
    if (mode < 1) {  // disposing issue with stylishs found thanks to Vcoc
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            cm.sendSimple("我叫艾瑞，是这家店的美发助手。如果你拥有 #b#t5150030##k 或 #b#t5151025##k 的话，我就可以为您服务。想要选择哪一种美发服务？\r\n#L1#更改发型：#i5150030##t5150030##l\r\n#L2#更改发色：#i5151025##t5151025##l");
        } else if (status == 1) {
            if (selection == 1) {
                beauty = 1;
                hairnew = Array();
                ...
                cm.sendYesNo("如果使用普通会员卡，你的发型将会#r随机#k改变，有可能变为全新风格。确定要使用 #b#t5150030##k 来改变你的发型吗？");
            } else if (selection == 2) {
                beauty = 2;
                haircolor = Array();
                ...
                cm.sendYesNo("如果使用普通会员卡，你的发色将会#r随机#k改变，有可能变为全新风格。确定要使用 #b#t5151025##k 来改变你的发色吗？");
            }
        }
        else if (status == 2){
            cm.dispose();
