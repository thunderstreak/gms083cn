...
function start() {
    cm.sendSimple("你好，虽然我还不太够资格，不过如果你愿意使用一张#b#t5152004##k的话，我也是可以为你提供服务的。但请注意，我的整容效果是随机的。\r\n#L2#改变脸型：#i5152004##t5152004##l");
}
    ...
    if (mode < 1) {
        ...
        if (status == 1) {
            if (selection == 2) {
                ...
                cm.sendYesNo("如果使用普通会员卡，你的脸型将会#r随机#k改变。确定要使用 #b#t5152004##k?");
            }
        }
        else if (status == 2){
