    ...
    if (mode == -1) {
        ...
        if(status == 0) {
            if(!cm.isQuestStarted(100400)) {
                cm.sendOk("你好啊 #b#h0##k, 我是爱情精灵#p9201001#。");     // thanks Periwinks (LuckyStory) for noticing Nana's introducing themselves as Nana (H)
                cm.dispose();
                return;
            }
            ...
            if(nanaLoc == -1) {
                cm.sendOk("你好啊 #b#h0##k, 我是爱情精灵#p9201001#。");
                cm.dispose();
                return;
            }
