...
function action(mode, type, selection) {
    if (mode < 1) {  // disposing issue with stylishs found thanks to Vcoc
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            cm.sendSimple("我是沙龙.谢默斯。如果有 #b#t5150019##k 或 #b#t5151016##k 的话，我就可以为您服务。想要选择哪一种美发服务？\r\n#L1#更改发型：#i5150019##t5150019##l\r\n#L2#更改发色：#i5151016##t5151016##l");
        } else if (status == 1) {
            if (selection == 1) {
                beauty = 1;
                hairnew = Array();
                ...
                cm.sendYesNo("如果使用一般会员卡，你的发型将会#r随机#k改变，有可能变为全新风格。确定要使用 #b#t5150019##k 来改变你的发型吗？");
            } else if (selection == 2) {
                beauty = 2;
                haircolor = Array();
                ...
                cm.sendYesNo("如果使用普通会员卡，你的发色将会#r随机#k改变，有可能变为全新风格。确定要使用 #b#t5150016##k 来改变你的发色吗？");
            }
        }
        else if (status == 2){
            cm.dispose();
