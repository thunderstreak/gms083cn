...
function action(mode, type, selection){
    ...
    if (actionx["Mental"]){
        ...
        cm.sendNext("去见 #b#p1052001##k，把 #b#t4031057##k 带回来给我。");
        cm.dispose();
        ...
        if (sel == 0){
            if (cm.getPlayer().getLevel() >= 70 && cm.getJobId() % 10 == 0){
                if (status == 0)
                    cm.sendYesNo("欢迎来到长老公馆，我是 #b#p2020011##k，飞侠长老。我会将我在街头厮混时学到的东西和格斗技巧传授给那些乐于倾听的人。你似乎想要在3转的道路上更进一步。然而太多的飞侠在我面前来来往往，却无法触碰3转的标准。那么你又如何？做好准备接受3转测试了吗？");
                else if (status == 1){
                    cm.getPlayer().setPartyQuestItemObtained("JB3");
                    cm.sendNext("很好，你即将接受力量与智慧测试来评定作为一名飞侠的资质。我会先向你解释前半部分的力量测试要如何进行。还记得废弃都市的 #b#p1052001##k 吗？ 去见他，他会指导你进行力量测试。完成任务后，带着 #b#t4031057##k 回来找我。");
                } else if (status == 2)
                    cm.sendNextPrev("只有在你通过了力量测试之后，才能开始智慧测试。#b#t4031057##k 将证明你确实通过了考试。在你到达那里之前，我会通知 #b#p1052001##k 你即将抵达，准备好一切。这份测验并不简单，但我对你有极大的信心。祝你好运。");
            }
        } else {
