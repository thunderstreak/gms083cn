...
function action(mode, type, selection) {
        if (mode == -1) {
                ...
                if(cm.getMapId() != 261000021) {
                        if(status == 0) {
                                cm.sendYesNo("请不要放慢脚步。如果你觉得无法进行下去，你的伙伴还有我都会理解你的...所以，你现在想退场吗？");
                        } else if(status == 1) {
                                cm.warp(926110700, 0);
                                cm.dispose();
                        }
