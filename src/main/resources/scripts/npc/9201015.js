...
function action(mode, type, selection) {
    if (mode < 1) {  // disposing issue with stylishs found thanks to Vcoc
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            cm.sendSimple("欢迎来到婚礼村美发店。如果你有 #b#t5150020##k 或 #b#t5151017##k,，就请到美发椅这边坐下。选择你想要使用的服务。\r\n#L1#更改发型：#i5150020##t5150020##l\r\n#L2#更改发色：#i5151017##t5151017##l");
        } else if (status == 1) {
            if (selection == 1) {
                beauty = 1;
                hairnew = Array();
                ...
                cm.sendStyle("我可以将你的头发修建成全新的造型，让你看起来更帅气美丽。只需要一张#b#t5150020##k。怎么样？我会仔细处理的，请你放心。选一个你喜欢的发型吧。", hairnew);
            } else if (selection == 2) {
                beauty = 2;
                haircolor = Array();
                ...
                cm.sendStyle("我可以将你的头发染成全新的颜色，让你看起来更帅气美丽。只需要一张#b#t5151017##k。怎么样？我会仔细处理的，请你放心。选一个你喜欢的发色吧。", haircolor);
            }
        }
        else if (status == 2){
            cm.dispose();
