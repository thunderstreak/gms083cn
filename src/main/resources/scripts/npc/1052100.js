...
function action(mode, type, selection) {
    if (mode < 1)  // disposing issue with stylishs found thanks to Vcoc
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            cm.sendSimple("你好，我是钱老板，这间美发沙龙的老板。如果你有 #b#t5150003##k 或 #b#t5151003##k，那么我就可以为你改变发型或发色。请选择\r\n#L1#更改发型：#i5150003##t5150003##l\r\n#L2#更改发色：#i5151003##t5151003##l");
        } else if (status == 1) {
            if (selection == 1) {
                beauty = 1;
                hairnew = Array();
                ...
                cm.sendStyle("我可以将你的头发染成全新的颜色，让你看起来更帅气美丽。只需要一张#b#t5151003##k。怎么样？我会仔细处理的，请你放心。选一个你喜欢的发色吧。", haircolor);
            }
        }
        else if (status == 2){
            cm.dispose();
